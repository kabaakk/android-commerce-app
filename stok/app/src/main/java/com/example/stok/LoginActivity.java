...
import com.example.stok.Model.Users;
import com.example.stok.Prevalent.Prevalent;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private TextView AdminLink,NotAdminPanelLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdminLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LoginButton.setText("Admin Girişi");
    ...
    private void LoginUser() {
        ...
        if(TextUtils.isEmpty(phone)){
            Toast.makeText(this,"Lütfen numaranızı giriniz",Toast.LENGTH_SHORT).show();
        } else if(TextUtils.isEmpty(password)) {
            Toast.makeText(this, "Lütfen parolanızı giriniz", Toast.LENGTH_SHORT).show();
        } else {
            loadingBar.setTitle("Giriş Yap");
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child(parentDbName).child(phone).exists()){
                    ...
                    Toast.makeText(LoginActivity.this,"Bu numara"+phone+"hesapla ilgili değil",Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
